...
function CustomNavbar() {
  ...
  useEffect(() => {
    if (navbarRef.current) {
      // Set a short timeout to ensure the navbar has rendered completely
  ...
  return (
    <>
                ...
                <Badge
                  ...
                  sx={{
                    "& .MuiBadge-badge": {
                      ...
                      fontWeight: "bold",
                      animation:
                        totalItems > 0 ? "pulse 1.5s infinite" : "none",
                      "@keyframes pulse": {
                        "0%": { transform: "scale(1)" },
      ...
      {/* Simple div placeholder that exactly matches the navbar height */}
      <div
        style={{
          height: navbarHeight,
          margin: 0,
      ...
      >
        {/* Rest of drawer code remains the same */}
